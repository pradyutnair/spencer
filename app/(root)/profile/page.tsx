...
export default async function HomePage() {
    ...
    return (
      <div className="w-full max-w-4xl mx-auto grid md:grid-cols-[250px_1fr] items-start gap-6 px-6 py-20">
                  ...
                  <Select>
                      ...
                      <SelectContent>
                          <SelectGroup>
                              ...
                              <SelectItem value="utc-3:30">(UTC-03:30) Newfoundland</SelectItem>
                              ...
                              <SelectItem value="utc+3">(UTC+03:00) Moscow Standard Time</SelectItem>
                              <SelectItem value="utc+3:30">(UTC+03:30) Iran Standard Time</SelectItem>
                              <SelectItem value="utc+4">(UTC+04:00) Gulf Standard Time</SelectItem>
                              <SelectItem value="utc+4:30">(UTC+04:30) Afghanistan Time</SelectItem>
                              ...
                              <SelectItem value="utc+6:30">(UTC+06:30) Cocos Islands Time</SelectItem>
                              ...
                              <SelectItem value="utc+8:45">(UTC+08:45) Southeastern Western Australia Standard Time</SelectItem>
                              <SelectItem value="utc+9">(UTC+09:00) Japan Standard Time</SelectItem>
                              <SelectItem value="utc+9:30">(UTC+09:30) Australian Central Standard Time</SelectItem>
                              <SelectItem value="utc+10">(UTC+10:00) Australian Eastern Standard Time</SelectItem>
                              <SelectItem value="utc+10:30">(UTC+10:30) Lord Howe Standard Time</SelectItem>
                              <SelectItem value="utc+11">(UTC+11:00) Solomon Islands Time</SelectItem>
                              <SelectItem value="utc+11:30">(UTC+11:30) Norfolk Island Time</SelectItem>
                              ...
                              <SelectItem value="utc+13">(UTC+13:00) Phoenix Islands Time</SelectItem>
                              <SelectItem value="utc+14">(UTC+14:00) Line Islands Time</SelectItem>
                          </SelectGroup>
                      </SelectContent>
                  </Select>
              </div>
