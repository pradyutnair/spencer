...
export const Feature = ({ title, description }: { title: string, description: string }) => {
    ...
    return (
        <div key={title} className="border border-white/30 px-5 py-10 text-center rounded-md sm:flex-1 relative">
            <motion.div className="absolute inset-0 border-2 border-zinc-100 rounded-md"
                style={{
                    WebkitMaskImage:
                        maskImage,
                    maskImage,
