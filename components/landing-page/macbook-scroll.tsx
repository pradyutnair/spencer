...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex  min-h-[250vh] flex-shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50  md:scale-100 md:py-80"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="h-96 max-w-full absolute inset-0 bg-[#010101] rounded-2xl p-2"
      >
