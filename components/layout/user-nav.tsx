...
export function UserNav() {
  ...
  const gradientBackground = generateGradient(
    user.name.split(' ')[0],
    user.name.split(' ')[1]
  );
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56" align="end" forceMount>
          <DropdownMenuLabel className="font-normal">
            ...
            <DropdownMenuSeparator className={'mb-2 mt-3'} />
          ...
          <DropdownMenuGroup>
            ...
            <form action={logoutAccount}>
              <Button
                variant="ghost"
                type="submit"
                className="mt-4 w-full dark:bg-zinc-800 light:bg-zinc-400 text-left hover:text-red-600"
              >
                Sign out
              </Button>
            </form>
